 ...
 */
/**
 * Precio admin grid block
 *
 * @category    Herfox
 * @package     Herfox_SalesForce
 * @author      Ultimate Module Creator
 */
class Herfox_SalesForce_Block_Adminhtml_Price_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Herfox_SalesForce_Block_Adminhtml_Price_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('herfox_salesforce/price')
            ->getCollection();
     ...
     *
     * @access public
     * @param Herfox_SalesForce_Model_Price
     * @return string
     * @author Ultimate Module Creator
     */
