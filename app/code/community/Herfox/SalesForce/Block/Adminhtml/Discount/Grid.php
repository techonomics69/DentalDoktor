 ...
 */
/**
 * Descuento admin grid block
 *
 * @category    Herfox
 * @package     Herfox_SalesForce
 * @author      Ultimate Module Creator
 */
class Herfox_SalesForce_Block_Adminhtml_Discount_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
     * constructor
     *
     ...
     *
     * @access protected
     * @return Herfox_SalesForce_Block_Adminhtml_Discount_Grid
     * @author Ultimate Module Creator
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('herfox_salesforce/discount')
            ->getCollection();
     ...
     *
     * @access public
     * @param Herfox_SalesForce_Model_Discount
     * @return string
     * @author Ultimate Module Creator
     */
