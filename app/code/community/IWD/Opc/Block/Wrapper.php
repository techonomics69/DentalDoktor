...
class IWD_Opc_Block_Wrapper extends  Mage_Core_Block_Template{
	...
	public function getDesignStyles(){
		...
		$styles = '';
		if(!empty($color4)){
			$styles.=".opc-wrapper-opc .btn, .opc-wrapper-opc .btn,";
			$styles.=".opc-wrapper-opc .discount-block .button, .opc-wrapper-opc .discount-block .button,";
			$styles.=".opc-wrapper-opc .payment-block dt,";
			$styles.=".opc-wrapper-opc .giftcard .button, .opc-wrapper-opc .giftcard .button,";
			$styles.=".opc-messages-action .button, .opc-messages-action .button,";
		...
		if(!empty($color5)){
			$styles.=".opc-wrapper-opc .btn:hover, .opc-wrapper-opc .btn:hover,";
			$styles.=".opc-wrapper-opc .discount-block .button:hover, .opc-wrapper-opc .discount-block .button:hover,";
			$styles.=".opc-wrapper-opc .payment-block dt:hover, .opc-wrapper-opc .payment-block dt.active,";
			$styles.=".opc-messages-action .button:hover, .opc-messages-action .button:hover,";
		...
		if(!empty($color6)){
			$styles.=".opc-wrapper-opc .discount-block .button,";
			$styles.=".opc-wrapper-opc .payment-block dt label,";
			$styles.=".opc-wrapper-opc .btn,";
			$styles.=".opc-wrapper-opc a:hover,";
			$styles.=".opc-wrapper-opc .giftcard .button,";
			$styles.=".opc-wrapper-opc .giftcard .check-gc-status,";
			$styles.=".opc-messages-action .button,";
			$styles.=".review-menu-block a.review-total, .review-menu-block a.review-total.open,";
			$styles.=".expand_plus";
			$styles.="{color:{$color6};}";
		}
		if(!empty($color8)){
			$styles.=".opc-wrapper-opc .discount-block .button:hover,";
			$styles.=".opc-wrapper-opc .payment-block dt:hover label, .opc-wrapper-opc .payment-block dt.active label,";
			$styles.=".opc-wrapper-opc .btn:hover,";
			$styles.=".opc-messages-action .button:hover, .opc-messages-action .button:hover,";
			$styles.=".review-menu-block a.review-total:hover, .review-menu-block a.review-total.open,";
			$styles.=".opc-wrapper-opc a:hover,";
		...
		if(!empty($color1)){
			$styles.=".opc-wrapper-opc .btn-checkout, .opc-wrapper-opc .btn-checkout,";
			...
			$p2 = ceil(hexdec($p2)/2);
			$p3 = ceil(hexdec($p3)/2);
			$styles.=".opc-wrapper-opc .btn-checkout.button-disabled{background-color:rgba({$p1},{$p2},{$p3}, .8);}";
		}
		if(!empty($color2)){
			$styles.=".opc-wrapper-opc .btn-checkout:hover, .opc-wrapper-opc .btn-checkout:hover";
			$styles.="{background-color:{$color2};}";
			$styles.=".opc-wrapper-opc .login-trigger:hover";
			$styles.="{background-color:{$color2} !important;}";
		}
		if(!empty($color3)){
			$styles.=".opc-wrapper-opc .login-trigger, .opc-wrapper-opc .btn-checkout";
			$styles.="{color:{$color3};}";
			$styles.=".opc-wrapper-opc .login-trigger:hover";
			$styles.="{color:{$color3} !important;}";
		}
		if(!empty($color7)){
			$styles.=".opc-wrapper-opc .btn-checkout:hover";
			$styles.="{color:{$color7};}";
			$styles.=".opc-wrapper-opc .login-trigger:hover";
