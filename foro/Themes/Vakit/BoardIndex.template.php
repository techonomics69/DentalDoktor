...
function template_main()
{
	...
	foreach ($context['categories'] as $category)
	{
		...
		echo'
		  <tr class="sub_cat">
		   ...
		   <td class="centertext">', $txt['rss'], '</td>
		   <td class="stats">', $txt['posts'], '</td>
		   <td class="stats">', $txt['topics'], '</td>
		   <td class="lastpost">',$txt['last_post'],'</td>
			...
			foreach ($category['boards'] as $board)
			{
				...
				// Show some basic information about the number of posts, etc.
					...
					echo '
				<td class="windowbg2 stats rss">
				<a class="forum-rss" href="'.$scripturl.'?action=.xml;board=' . $board['id'] . ';type=rss"><i class="fa fa-rss"></i>
				</a></td>
	...
	<div id="posting_icons" class="floatleft">';
		...
		<dl class="forum_legend">
			<dt><span class="forum-status new_some"></span></dt>
			<dd>', $txt['new_posts'], '</dd>
...
function template_info_center()
{
	...
	echo '
	<br class="clear" />
	<div class="innerframe roundstats">
		<div class="cat_bar">
			<h3 class="catbg">
