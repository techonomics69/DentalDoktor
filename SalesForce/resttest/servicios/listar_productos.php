...
*/
    ...
    echo "<table border='1'>";
    echo "<tr><th>Id</th><th>Nombre</th><th>Descripcion</th><th>Codigo Producto</th><th>Marca</th><th>Tiempo Entrega</th></tr>";
    foreach ((array) $response as $record) {
        echo "<tr><td>".$record['Id']."</td><td>".$record['Name']."</td><td>".$record['Description']."</td><td>".$record['ProductCode']."</td><td>".$record['Marca__c']."</td><td>".$record['Tiempo_de_Entrega__c']."</td></tr>";
    }
    echo "</table>";
}
?>
