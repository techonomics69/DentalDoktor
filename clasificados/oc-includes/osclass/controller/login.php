        ...
        function doModel()
        {
            switch( $this->action ) {
                case('login_post'):     //post execution for the login
                                        ...
                                        // HERFOX: DISABLED CSRF CHECK VALIDATE
										//osc_csrf_check();
                    ...
                    //echo "BANNED: ".$banned."<br>";
                                        ...
                                        if( empty($url_redirect) ) {
                                            $url_redirect = Params::getParam('url_redirect');
                                        }
										$page_redirect = '';
                    ...
                    //exit;
										if($logged==0) {
                                            ...
                                            $redirect = osc_apply_filter('correct_login_url_redirect', $url_redirect);
